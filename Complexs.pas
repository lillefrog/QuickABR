...
type
  ...
  TComplex = packed record
    Re: Double; // Real part    //TFloat
    Im: Double; // Imaginary part   //TFloat
  end;
...
function Complex(Re: Double; Im: Double): TComplex;

// Add complex numbers (Result = C1 + C2)
function ComplexAdd(const C1, C2: TComplex): TComplex; //TFloat
...
function ComplexScl(Scale: Double; const C: TComplex): TComplex; // TFloat

// Get the magnitude of the complex number C
function ComplexMag(const C: TComplex): Double ;    //    TFloat

// Get the phase of the complex number C (in radians, between -pi and pi)
function ComplexPhase(const C: TComplex): Double;   // TFloat

implementation

function Complex(Re: Double; Im: Double): TComplex; // TFloat
// Set a complex number
begin
  Result.Re := Re;
  Result.Im := Im;
